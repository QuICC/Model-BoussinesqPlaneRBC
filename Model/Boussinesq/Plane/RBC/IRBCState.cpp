...
// Project includes
//
#include "Model/Boussinesq/Plane/RBC/IRBCState.hpp"
...
VectorFormulation::Id IRBCState::SchemeFormulation()
{
   return VectorFormulation::TORPOL;
}

std::string IRBCState::version() const
{
   return std::string(gitHash);
}

void IRBCState::addStates(SharedStateGenerator spGen)
{
